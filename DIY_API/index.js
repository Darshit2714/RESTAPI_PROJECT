...
app.get("/random",(req,res)=>{
  var randomJokeId = Math.floor(Math.random()*jokes.length)
  // console.log(randomJokeId);
  res.send(jokes[randomJokeId])
})

//2. GET a specific joke
app.get("/jokes/:id",(req,res)=>{ //:xyz(bind variable) assign value in xyz in runtime
  var jokeId = parseInt(req.params.id)
  // console.log(jokeId);
  var reqJoke = jokes.find((joke)=>joke.id==jokeId)
  res.json(reqJoke)
})
...
app.get("/filter",(req,res)=>{
  ...
  var filterJoke = jokes.filter((joke)=>joke.jokeType==type)
  res.json(filterJoke)
})
...
app.put("/jokes/:id",(req,res)=>{
  ...
  var jokeIndex =jokes.findIndex((joke)=>joke.id==jokeId)
...
app.patch("/jokes/:id",(req,res)=>{
  var jokeId = parseInt(req.params.id)
  var existingJoke = jokes.find((joke)=>joke.id==jokeId)
  var replace = {
    id:jokeId,
...
app.delete("/jokes/:id",(req,res)=>{
  ...
  var jokeIndex = jokes.findIndex((joke)=>joke.id==id)
